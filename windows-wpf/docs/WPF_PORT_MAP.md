...
| Random Seed | Done | Native deterministic template generation with style and intensity controls, visibly refreshed cast roles/personas, respects topic/global/agent/narrator locks, preserves transcript. |
...
| Cast preview | Done | Read-only agent/persona cards. |
