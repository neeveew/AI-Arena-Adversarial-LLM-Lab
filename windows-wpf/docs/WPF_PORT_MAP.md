...
| Random Seed | Done | Native deterministic template generation with visibly refreshed cast roles/personas, respects topic/global/agent/narrator locks, preserves transcript. |
