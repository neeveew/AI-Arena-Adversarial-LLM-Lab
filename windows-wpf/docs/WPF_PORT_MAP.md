...
| Random Seed | Done | Native deterministic template generation with role pack, style, pressure, and absurdity controls; Absurd Lab uses a seeded-shuffle 50+ role library with associated persona functions; respects topic/global/agent/narrator locks, preserves transcript. |
