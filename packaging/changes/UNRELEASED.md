...
This is the development ledger between published versions. Keep
`0.4.127-beta` as the declared product version until the repository owner
chooses to publish a sufficiently substantial batch. At release time, move the
verified bullets into the new versioned `.txt` change file.
