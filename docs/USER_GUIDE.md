...
>
> Guide version: **0.4.136-beta** · Reviewed: **2026-08-14**

AI Arena - Lite: Adversarial LLM Lab is a native Windows app for structured conversations between local or OpenAI-compatible language models. The in-app Help Center and this full Markdown guide use the same article source.

## Contents

- **Start Here**
  - [What do you want to do?](#article-home) — Choose a task and follow the shortest safe path through AI Arena - Lite.
...
- **Save & Automate**
  ...
  - [Internet, Privacy & Local Data](#article-internet-privacy) — Control optional search/fetch tools and understand what AI Arena - Lite stores or sends.
...
*Choose a task and follow the shortest safe path through AI Arena - Lite.*
...
|---|---|---|
| Run AI Arena - Lite for the first time | [Quick Start](#article-quick-start) | A connected, assigned model and one successful turn |
...
*Control optional search/fetch tools and understand what AI Arena - Lite stores or sends.*
