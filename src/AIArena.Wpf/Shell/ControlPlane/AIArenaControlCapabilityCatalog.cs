...
internal static class AIArenaControlCapabilityCatalog
{
    ...
    [
        ...
        Capability(AIArenaControlCommands.AppScreenshot, "app", "Save the current AI Arena - Lite window visual as a PNG screenshot, optionally at a bounded QA render DPI.", optional: ["path", "renderDpiScale"]),
        Capability(AIArenaControlCommands.AppQaWindowSize, "qa", "Set the current AI Arena - Lite window to a bounded verification size in DIP.", ["width", "height"]),
        ...
        Capability(AIArenaControlCommands.ExperimentFeatureSelect, "experiment", "Open Experiment Lab, select one registered feature, and request its normal safe refresh.", ["key"]),
