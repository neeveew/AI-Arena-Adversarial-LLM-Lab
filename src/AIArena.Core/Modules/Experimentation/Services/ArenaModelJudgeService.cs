...
public sealed class ArenaModelJudgeService
{
    ...
    private static string ProviderProfileFingerprint(ModelProviderConfig value) => ArenaEvaluationEvidenceCodec.Sha256(string.Join(
        ...
        value.ConfiguredContextWindow.ToString(CultureInfo.InvariantCulture),
        ModelHistoryPolicies.NormalizeHistoryPolicy(value.HistoryPolicy),
        ModelResponseTones.NormalizeResponseTone(value.ResponseTone),
