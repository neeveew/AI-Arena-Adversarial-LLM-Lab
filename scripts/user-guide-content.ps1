...
[void]$builder.AppendLine('# AI Arena - Lite Help Center')
...
[void]$builder.AppendLine()
[void]$builder.AppendLine('AI Arena - Lite: Adversarial LLM Lab is a native Windows app for structured conversations between local or OpenAI-compatible language models. The in-app Help Center and this full Markdown guide use the same article source.')
[void]$builder.AppendLine()
